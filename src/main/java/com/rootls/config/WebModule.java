...
public class WebModule extends WebMvcConfigurerAdapter
{
	...
	public void addResourceHandlers(ResourceHandlerRegistry aRegistry)
	{
		...
		aRegistry.addResourceHandler("/WEB-INF/view/*").addResourceLocations("classpath:/webapp/WEB-INF/view/*");
		aRegistry.addResourceHandler("/favicon.ico").addResourceLocations("classpath:/webapp/WEB-INF/view/images/favicon.ico");
	}
